...
At the same time they give us - as developers - a shared vocabulary. And at the same time it allows us to compose sentences containing seemingly normal words which - when spoken - makes _absolutely_ no sense to non-developers
